    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(patientInfoManager, SIGNAL(sendTempData(QString, QString)), choosePatientManager, SLOT(sendedTempData(QString, QString)));   //인자 필요없지만 signal 재활용 위해 사용
